...
try:  # Support both `app.` and `backend.app.` import roots
    from app.models import ScanResult  # type: ignore
except ModuleNotFoundError:  # pragma: no cover - test collection path
    from backend.app.models import ScanResult  # type: ignore
