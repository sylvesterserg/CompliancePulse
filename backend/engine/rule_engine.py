...
try:  # dual import roots for tests vs runtime
    ...
    from app.security.utils import ensure_command_allowed  # type: ignore
except ModuleNotFoundError:  # pragma: no cover
    from backend.app.config import settings  # type: ignore
    from backend.app.models import Rule  # type: ignore
    from backend.app.security.utils import ensure_command_allowed  # type: ignore
